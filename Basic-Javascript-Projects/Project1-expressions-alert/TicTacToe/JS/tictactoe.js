...
//draswLine() function is called to draw a line on the screen if the condition is net.
...
function disableClick() {
    ...
    setTimeout (function () { body.stle.pointerEvents = 'auto'; }, 1000);
}

//This function takes a string parameter of the path you set earlier for
//placement sound('./media/place.mp3')
function audio(audioURL) {
    //We create a new audio object and we pass th path as a parameter.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
     ...
     //this line indicates where the end of a lines x-axis is.
     y2 = coordY2,
     //This variable stores temporarily x axis data we update in our animation loop.
     x = x1,
     ...
     function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if(x < x2) { x += 10; }
            //This condtionadds 10 to the previous y endpoint.
            if (y < y2) { y += 10; }
            //This condition is similar to the one above.
            //This is neccesary for the 6, 4, 2 win conditions.
